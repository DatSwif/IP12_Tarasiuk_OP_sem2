...
string toRoman(int arabic)
{
    ...
    while ((pow10 < 3) && (arabic > 0))
    {
        ...
        case 1:
            res = RD[pow10][0] + res;
        case 2:
            res = "" + RD[pow10][0] + RD[pow10][0] + res;
        case 3:
            res = "" + RD[pow10][0] + RD[pow10][0] + RD[pow10][0] + res;
        case 4:
            res = "" + RD[pow10][0] + RD[pow10][1] + res;
        case 5:
            res = RD[pow10][1] + res;
        case 6:
            res = "" + RD[pow10][1] + RD[pow10][0] + res;
        case 7:
            res = "" + RD[pow10][1] + RD[pow10][0] + RD[pow10][0] + res;
        case 8:
            res = "" + RD[pow10][1] + RD[pow10][0] + RD[pow10][0] + RD[pow10][0] + res;
        case 9:
            res = "" + RD[pow10][0] + RD[pow10][2] + res;
        }
        arabic /= 10;
        pow10 += 1;
    }
